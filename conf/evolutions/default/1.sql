...
create table "INTERVIEW_SESSION" ("ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"SESSION_DATE" DATE NOT NULL,"INTERVIEWER" VARCHAR NOT NULL,"INTERVIEWEE" VARCHAR NOT NULL,"NB_OF_QUESTIONS" INTEGER NOT NULL,"QUESTION_MODE" INTEGER NOT NULL,"MAX_DIFFICULTY_LEVEL_ID" BIGINT NOT NULL,"SESSION_STATUS" INTEGER NOT NULL,"COMMENTS" VARCHAR NOT NULL);
